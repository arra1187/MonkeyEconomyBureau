...
import com.example.costcalculator30.databinding.FragmentDatabaseTestBinding;
...
public class DatabaseTest extends Fragment
{
    ...
    private FragmentDatabaseTestBinding binding;
    ...
    {
        binding = FragmentDatabaseTestBinding.inflate(inflater, container, false);
